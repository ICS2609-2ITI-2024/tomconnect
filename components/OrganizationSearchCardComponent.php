...
?>
        <div class="organization-search-card-component">
            <a href="profile.php?p=<?= $organization_name ?>" class="profile-picture">
            ...
            <div class="author-container">
                <div class="author-name-and-date-published">
                    <h4 class="mb-0 nameStyle"><a href="profile.php?p=<?= $organization_name ?>"><?= ucwords($organization_name) ?></a></h4>
