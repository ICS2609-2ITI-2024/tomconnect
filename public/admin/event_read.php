    ...
    <div class="event-container">
        ...
        if (!empty($full_events)) {
            ...
            foreach ($full_events as $row) {
                ...
                echo '<td>';
                echo '<a href="event_read.php?event_id=' . htmlspecialchars((string) $row['event_id']) . '" class="mr-1" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                echo '<a href="event_update.php?event_id=' . htmlspecialchars((string) $row['event_id']) . '" class="mr-1" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                echo '<a href="event_delete.php?event_id=' . htmlspecialchars((string) $row['event_id']) . '" class="mr-1" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                echo '</td>';
                echo '</tr>';
            }
